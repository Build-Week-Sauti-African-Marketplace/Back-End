package local.tyler.africanmarketplace.logging;
...
{
    @Around(value = "@within(local.tyler.africanmarketplace.logging.Loggable) || @annotation(local.tyler.africanmarketplace.logging.Loggable)")
