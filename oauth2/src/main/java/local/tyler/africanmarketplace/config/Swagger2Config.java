package local.tyler.africanmarketplace.config;

import com.fasterxml.classmate.TypeResolver;
import local.tyler.africanmarketplace.models.ErrorDetail;
import local.tyler.africanmarketplace.models.TokenModel;
